...
Yosinaは、日本語の文章で使われる文字や記号を専門的に扱う字訳 (transliteration) ライブラリです。日本語は独自の文字体系を持つ長い歴史があり、中国語や英語由来の文字を取り入れているだけでなく、ドイツ語やフランス語を含む様々な文字体系からの影響も受けています。また、日本の符号化文字集合規格は非常に複雑で、Unicode標準が広く普及した後でも、依然として不確実性を引き起こしています。
...
* 視覚的に曖昧な文字の字訳：カタカナ・ひらがな間のハイフンマイナスを文脈に応じて長音記号に置換

    <svg><use href="/assets/img/conversion-example3.svg#a" /></svg>

* 視覚的に曖昧な文字の字訳：視覚的に曖昧な長音記号を文脈に応じてハイフンマイナスに置換
...
* [CJK部首トランスリテレータ](/ja/transliterators/cjk-radicals/)
* [表意文字注記トランスリテレータ](/ja/transliterators/ideographic-annotations/)
* [数学用英数記号トランスリテレータ](/ja/transliterators/mathematical-alphanumerics/)
* [ハイフントランスリテレータ](/ja/transliterators/hyphens/)
* [旧字体から新字体への漢字トランスリテレータ](/ja/transliterators/traditional-to-new-kanjis/)
* [JIS X 0201および類似文字トランスリテレータ](/ja/transliterators/jisx0201-and-alike/)
* [ひらがな・カタカナ合成トランスリテレータ](/ja/transliterators/hiragana-katakana-composition/)
* [長音記号トランスリテレータ](/ja/transliterators/prolonged-sound-marks/)
* [結合文字トランスリテレータ](/ja/transliterators/combined-chars/)
* [丸囲み・角囲みトランスリテレータ](/ja/transliterators/circled-or-squared/)